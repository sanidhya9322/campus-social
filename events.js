...
import { getFirestore, collection, addDoc, onSnapshot, query, orderBy, getDoc, doc, updateDoc, arrayUnion } from "https://www.gstatic.com/firebasejs/10.8.1/firebase-firestore.js";
...
createBtn.addEventListener('click', async () => {
    ...
    if (!title || !date || !location || !userProfile) {
